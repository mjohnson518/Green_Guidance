...
* **Determine electricity grid emissions factors**: The next step is obtaining the electricity grid emissions intensity figure (i.e., emissions factor) to use with the reported activity data.
  ...
  * \*\*\*\*[**Annex 1: Carbon Accounting Methodologies Hierarchy**](../../annex-1-carbon-accounting-methodologies-hierarchy.md) provides an overview of the necessary sub-steps for determining electricity grid emissions factors based on the three ranked methods.
